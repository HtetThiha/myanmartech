...
engine = create_engine('mysql+mysqlconnector://<user>:<password>@localhost/ingestdata?auth_plugin=mysql_native_password', echo=False)
...
#             print("more images: "+ hasmoreimages.text)
        ...
        if position%10 == 0:
            ...
            series.to_sql('kumudranews2', con=engine, if_exists='append', index= False)
            items = []
