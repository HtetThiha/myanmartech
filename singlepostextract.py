...
engine = create_engine('mysql+mysqlconnector://root:D3loitte01!@localhost/ingestdata?auth_plugin=mysql_native_password', echo=False)
...
# # translatemessage = 
# # div[aria-posinset='1'] > div >div>div>div>div>div:nth-child(2)>div>div:nth-child(3) > div:nth-child(2)
...
#             series.to_sql('crph2', con=engine, if_exists='append', index= False)
#             items = []
